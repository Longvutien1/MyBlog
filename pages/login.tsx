            ...
            <div className="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
                <div className="max-w-md w-full space-y-8 bg-white drop-shadow-2xl px-8 py-16">
                    <div>
                        ...
                        <h2 className="mt-6 text-center text-3xl tracking-tight font-bold text-gray-900">Đăng nhập</h2>
                    ...
                    <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)} >
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="text-sm">
                                <Link href="/register"><a  className="font-medium text-indigo-600 hover:text-indigo-500"> Đăng kí tài khoản mới </a></Link>
                            </div>
                        </div>
                        <div>
